...
layout = [
  ...
  [
    sg.B("Log in", enable_events=True, key="-LOGIN_USER-"),
  ...
  [
    ...
    sg.Column(
      [
        [ sg.B("INPUTS ->", enable_events=True, key="-SEND_INPUT-") ],
        [ sg.B("<- INPUTS", enable_events=True, key="-RETURN_INPUT-") ],
        [ sg.HorizontalSeparator()],
        [ sg.B("OUTPUTS ->", enable_events=True, key="-SEND_OUTPUT-") ],
  ...
  [
    sg.In("", visible=False, enable_events=True, key="-DOWNLOAD_DATASET_FILENAME-"),
    sg.SaveAs("Download Dataset",
